...
const BuyNowModal = ({ isOpen, onClose, productName }: BuyNowDialog) => {
    ...
    } = validateInput(enteredUserName, false, false, false, wasNameInputTouched);
    const {
        isValid: isEnteredPhoneValid,
        isInvalid: isPhoneInputInvalid,
        errorText: phoneErrorMessage,
    } = validateInput(enteredUserPhone, true, false, false, wasPhoneInputTouched);
    ...
    const modalContent = (
        <>
            ...
            <ModalFooter>
                ...
                <Button colorScheme="green" onClick={onSendOrderHandler} isLoading={isOrderSending}>
                    Call me
                </Button>
            </ModalFooter>
        </>
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} isCentered>
            <ModalOverlay />
            <ModalContent>{isOrderSending ? successMessage : modalContent}</ModalContent>
        </Modal>
    );
};
