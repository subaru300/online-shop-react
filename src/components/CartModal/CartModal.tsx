...
const CartModal = () => {
    ...
    const modalContent = (
        <>
            <ModalHeader fontSize="32px">
                {cartItems.length !== 0 ? 'Place your order' : 'Your cart is empty'}
            </ModalHeader>
            <ModalCloseButton />
            <ModalBody>
                <CartList />
            ...
            <ModalFooter>
                {isOrderDetailsOpen ? (
                    ...
                    <Box>
                        ...
                        <Button colorScheme="green" isDisabled={cartItems.length === 0} onClick={onNextStepHandler}>
                            Next step
                        </Button>
                    </Box>
                )}
    ...
    return (
        <Modal onClose={onClose} isOpen={isOpen} isCentered size="2xl">
            <ModalOverlay />
            <ModalContent>{isOrderSent ? successMessage : modalContent}</ModalContent>
        </Modal>
    );
};
